// ==UserScript==
// @name         Aviator Strategy Bot (v2 fix-recovery)
// @namespace    https://aviator.dafeapp.com
// @version      1.1.0
// @description  Two-panel bot — prod_v2 guardrails with bet caps, no deficit cap, persistent recovery
// @author       Aviator Bot
...
(function () {
    ...
    const DEFAULTS = {
        ...
        P2_RECOVERY_SCOPE:        'individual',  // individual = P2 only covers its own deficit (safer)
        P1_TRIGGER_MULT:          2.5,
        P2_LOW_STREAK_MIN:        1.4,
        P2_LOW_STREAK_MAX:        3.5,
        STOP_ON_PROFIT:           50000,
        STOP_ON_LOSS:             -50000,
        MAX_RECOVERY_BET:         500,           // KES hard cap on P1 recovery bet
        MAX_P2_BET:               200,           // KES hard cap on P2 recovery bet
        MAX_ASSIST_BET:           300,           // KES hard cap on P1 assist bet
        RECOVERY_DEFICIT_CAP:     0,             // 0 = disabled (was 2000, blocked recovery)
        BURST_COOLDOWN:           0,
        TRIGGER_LOSS_COOLDOWN:    0,             // 0 = disabled (was 2, slowed re-entry)
