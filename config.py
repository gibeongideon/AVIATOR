...
PANEL1_CASHOUT  = 3.0     # Safer option; aggressive option: 4.0x
PANEL2_CASHOUT  = 2.5     # Safer option; alternatives: 2.0x or aggressive 3.0x
...
P1_TRIGGER_MULT     = 999.0  # Effectively disable high-crash trigger; use low-streak setup instead
P1_LOW_STREAK_MAX   = 2.0  # Also trigger P1 when recent crashes all stay at/below this
P1_LOW_STREAK_COUNT = 5    # How many consecutive low crashes needed to trigger P1
P1_MAX_BET_ROUNDS   = 1   # P1 bets at most this many rounds per burst

# ── P2 trigger (independent) ─────────────────────────────────────────────────
P2_TRIGGER_MULT     = 999.0  # Effectively disable high-crash trigger; use low-streak setup instead
P2_LOW_STREAK_MAX   = 2.0  # Also trigger P2 when recent crashes all stay at/below this
P2_LOW_STREAK_COUNT = 5    # How many consecutive low crashes needed to trigger P2
P2_MAX_BET_ROUNDS   = 1    # P2 bets at most this many rounds per burst
